#!/usr/bin/env python3
"""Generate cinematic portrait images optimized for faces."""
...
def build_workflow(prompt, negative_prompt, width, height, steps, cfg, seed):
    return {
        ...
        "7": {
            ...
            "inputs": {"images": ["6", 0], "filename_prefix": "openclaw_portrait"},
        },
    }


def main():
    parser = argparse.ArgumentParser(description="Generate cinematic portraits")
    parser.add_argument("prompt", help="Portrait description")
    ...
    parser.add_argument("--negative", default="watermark, text, logo, blurry, deformed hands, extra fingers")
