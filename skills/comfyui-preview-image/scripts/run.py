#!/usr/bin/env python3
"""Fast 12-step preview image generation using ComfyUI + Stable Diffusion 1.5."""
...
def build_workflow(prompt, negative_prompt, width, height, steps, cfg, seed):
    return {
        ...
        "7": {
            ...
            "inputs": {"images": ["6", 0], "filename_prefix": "openclaw_preview"},
        },
    }
...
def main():
    parser = argparse.ArgumentParser(
        description="Fast 12-step preview image generation"
    )
    ...
    print(f"Generating preview image (fast 12-step)...")
