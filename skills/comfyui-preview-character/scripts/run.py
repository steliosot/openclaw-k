#!/usr/bin/env python3
"""Fast 12-step character concept preview using ComfyUI + Stable Diffusion 1.5."""
...
DEFAULT_NEGATIVE = (
    "watermark, text, blurry, low quality, deformed, extra fingers, "
...
def build_workflow(prompt, negative_prompt, width, height, steps, cfg, seed):
    return {
        ...
        "7": {
            ...
            "inputs": {"images": ["6", 0], "filename_prefix": "openclaw_preview_char"},
        },
    }
...
def main():
    parser = argparse.ArgumentParser(
        description="Fast 12-step character concept preview"
    )
    ...
    print(f"Generating character preview (fast 12-step)...")
    ...
    print(f"Character preview saved to: {output_path}")
