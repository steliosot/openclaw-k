...
def main():
    parser = argparse.ArgumentParser(description="Download a generated image from ComfyUI server")
    parser.add_argument("output_path", help="Local path to save the downloaded image")
    ...
    print(f"Downloading image: {args.filename}", file=sys.stderr)
    try:
